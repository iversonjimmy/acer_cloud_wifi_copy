//
//  AppDelegate.m
//  SSOLoginWithCleanAppTest
//
//  Created by build on 12/11/8.
//
//
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    test_password = [NSString stringWithContentsOfFile: [[NSBundle mainBundle] pathForResource:@"CCDTestAccountPassword" ofType:@""]
                                              encoding: NSUTF8StringEncoding
                                                 error: Nil];
     ...
     */
    rv = test_login_with_password([test_account UTF8String], [test_password UTF8String]);
    if (rv == CCD_OK) {
        /*
    ...
    fflush(stdout);
    [TestHelper postLogFile:@"ios_ccdSSOTest_normal_clean_app.log"];
