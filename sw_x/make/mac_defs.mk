##########################################################################
# Global defs for building with Mac OS X command line go here
##########################################################################
...
#include $(SRCROOT)/devtools/mac/mac_env_defs.mk
...
C_CXX_FLAGS += -g3
POST_PROCESS_BINARY = # TODO: bug 9306: temporarily leaving in debug symbols $(SEPARATE_DEBUG_INFO_BINUTILS)
...
C_CXX_FLAGS += -DHOST_IS_LITTLE_ENDIAN -D_FILE_OFFSET_BITS=64
