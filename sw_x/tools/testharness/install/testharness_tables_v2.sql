...
DROP TABLE IF EXISTS test_suite_instance;
CREATE TABLE IF NOT EXISTS test_suite_instance (
	id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
	test_run_id INT,
	test_suite_id INT,
	start_time INT,
...
DROP TABLE IF EXISTS test_case_instance_v2;
