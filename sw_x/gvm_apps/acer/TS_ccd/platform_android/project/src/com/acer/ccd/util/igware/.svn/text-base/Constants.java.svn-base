...
public class Constants {
    ...
    public static final String DISALLOWED_CHARS = DISALLOWED_CHARS_DISPLAYABLE
            + "\t\r\n";
    
    public static final int RESULT_RESTART = Activity.RESULT_FIRST_USER + 1;
    public static final int RESULT_EXIT = Activity.RESULT_FIRST_USER + 2;
    public static final int RESULT_BACK_TO_MAIN = Activity.RESULT_FIRST_USER + 3;
    ...
    public static final String CAMERA_FOLDER_PATH = "/sdcard/DCIM/Camera";
    public static final String DEFAULT_FOLDER_PATH = "/sdcard/acerCloud/";
