// ACloudSyncedRF.h : Declaration of the CACloudSyncedRF
...
class ATL_NO_VTABLE CACloudSyncedRF :
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CACloudSyncedRF, &CLSID_ACloudSyncedRF>,
...
DECLARE_REGISTRY_RESOURCEID(IDR_ACLOUDSYNCEDRF)

DECLARE_NOT_AGGREGATABLE(CACloudSyncedRF)

BEGIN_COM_MAP(CACloudSyncedRF)
...
OBJECT_ENTRY_AUTO(__uuidof(ACloudSyncedRF), CACloudSyncedRF)
