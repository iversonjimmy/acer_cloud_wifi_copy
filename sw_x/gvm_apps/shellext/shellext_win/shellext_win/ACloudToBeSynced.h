// ACloudToBeSynced.h : Declaration of the CACloudToBeSynced
...
class ATL_NO_VTABLE CACloudToBeSynced :
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CACloudToBeSynced, &CLSID_ACloudToBeSynced>,
...
DECLARE_REGISTRY_RESOURCEID(IDR_ACLOUDTOBESYNCED)

DECLARE_NOT_AGGREGATABLE(CACloudToBeSynced)

BEGIN_COM_MAP(CACloudToBeSynced)
...
OBJECT_ENTRY_AUTO(__uuidof(ACloudToBeSynced), CACloudToBeSynced)
