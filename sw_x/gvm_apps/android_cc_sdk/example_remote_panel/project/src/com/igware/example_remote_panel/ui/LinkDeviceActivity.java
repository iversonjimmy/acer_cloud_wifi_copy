...
public class LinkDeviceActivity extends CcdActivity {
    
    // private static final String LOG_TAG = "LinkDeviceActivity";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(R.string.Label_LinkDevice);
    ...
    private class LinkDeviceTask extends AsyncTask<String, Void, Integer> {
        
        @Override
        protected Integer doInBackground(String... params) {

            String deviceName = params[0];
            int result = mBoundService.linkDevice(deviceName);
            return result;
        }
        ...
        protected void onPostExecute(Integer result) {
            ...
            if (result == 0) {
                Toast.makeText(LinkDeviceActivity.this,
                        R.string.Msg_LinkedDevice, Toast.LENGTH_SHORT).show();
                ...
                showDialog(Constants.DIALOG_LINK_DEVICE_FAILED, bundle);
            }
        }
    }
    
    public void onClick_LinkDevice(View view) {
        ...
        mProgressDialog = ProgressDialog.show(this, "",
                getText(R.string.Msg_LinkingDevice), true);
        new LinkDeviceTask().execute(deviceName);
    }
    ...
    protected void onPrepareDialog(int id, Dialog dialog, Bundle args) {
        ...
        switch (id) {
        case Constants.DIALOG_LINK_DEVICE_FAILED:
    ...
    protected Dialog onCreateDialog(int id, Bundle args) {
        ...
        case Constants.DIALOG_LINK_DEVICE_FAILED: 
            ...
            builder.setMessage("")
                    .setTitle(getText(R.string.Label_LinkDeviceFailed))
                    .setCancelable(false)
                    .setNeutralButton("OK",
