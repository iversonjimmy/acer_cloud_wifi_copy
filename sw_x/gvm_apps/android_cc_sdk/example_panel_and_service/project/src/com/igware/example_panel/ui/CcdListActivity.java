...
import com.igware.example_panel.CcdiClientForAcpanel;
import com.igware.example_panel.util.Utils;


abstract public class CcdListActivity extends ListActivity {
    ...
    private static final String LOG_TAG = "CcdListActivity";
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        mDelegate.onCreateOptionsMenuForList(menu);
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        mDelegate.onPrepareOptionsMenuForList(menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        boolean handled = mDelegate.onOptionsItemSelectedForList(item);
        if (!handled) {
