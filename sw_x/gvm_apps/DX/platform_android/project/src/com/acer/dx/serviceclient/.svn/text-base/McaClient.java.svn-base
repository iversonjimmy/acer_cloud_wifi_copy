...
//import com.acer.dx.provider.CloudMediaColumns;
import com.acer.dx.serviceclient.McaClientRemoteBinder;
...
//                            metadata.put( CloudMediaColumns.THUMBNAIL_URL, currObject.getVideoItem( ).getThumbnail( ) );
                            metadata.put( "ThumbnailUrl", currObject.getVideoItem( ).getThumbnail( ) );
                        }
...
//                            metadata.put( CloudMediaColumns.THUMBNAIL_URL, currObject.getPhotoItem( ).getThumbnail( ) );
                            metadata.put( "ThumbnailUrl", currObject.getPhotoItem( ).getThumbnail( ) );
                        }
