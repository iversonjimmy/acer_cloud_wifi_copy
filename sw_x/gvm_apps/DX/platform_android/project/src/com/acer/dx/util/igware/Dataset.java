...
/**
 * Represent Dataset, which is the top level of storage nodes in a cloud.
 * @author cindy
 *
 */
public class Dataset extends SyncListItem {
    ...
    /*
     * Did the dataset have subscription when we first read it from cloud?
     */
    ...
    /*
     * Called when nothing under this path is subscribed. 
