...
public final class CcdSdkDefines {
    ...
    private static final String ATHORITY = "com.acer.ccd.ThumbnailProvider";
    public static final Uri THUMBNAIL_CONTENT_URI = Uri.parse("content://" + ATHORITY);
}
