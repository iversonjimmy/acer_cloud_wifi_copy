...
void TestDBConstraint::RunTests()
{
    try {
        ...
        if (this->db_options & DATASETDB_OPTION_CASE_INSENSITIVE) {
            rv = sqlite3_exec(getSqlite(), "INSERT INTO component (id, name, name_upper, ctime, mtime, type, version) VALUES (1, 'a', 'A', 0, 0, 0, 0)", NULL, NULL, &errmsg);
        } else {
            rv = sqlite3_exec(getSqlite(), "INSERT INTO component (id, name, ctime, mtime, type, version) VALUES (1, 'a', 0, 0, 0, 0)", NULL, NULL, &errmsg);
        }
        if (rv != SQLITE_OK) {
            fatal("Failed to insert into component table. Error %d", rv);
        }
        if (this->db_options & DATASETDB_OPTION_CASE_INSENSITIVE) {
            rv = sqlite3_exec(getSqlite(), "INSERT INTO component (id, name, name_upper, ctime, mtime, type, version) VALUES (2, 'b', 'B', 0, 0, 0, 0)", NULL, NULL, &errmsg);
        } else {
            rv = sqlite3_exec(getSqlite(), "INSERT INTO component (id, name, ctime, mtime, type, version) VALUES (2, 'b', 0, 0, 0, 0)", NULL, NULL, &errmsg);
        }
        if (rv != SQLITE_OK) {
            fatal("Failed to insert into component table. Error %d", rv);
        }
        ...
        if (this->db_options & DATASETDB_OPTION_CASE_INSENSITIVE) {
            rv = sqlite3_exec(getSqlite(), "INSERT INTO component (name, name_upper, ctime, mtime, type, version) VALUES (NULL, 'AA', 0, 0, 0, 0)", NULL, NULL, &errmsg);
        } else {
            rv = sqlite3_exec(getSqlite(), "INSERT INTO component (name, ctime, mtime, type, version) VALUES (NULL, 0, 0, 0, 0)", NULL, NULL, &errmsg);
        }
        ...
        if (this->db_options & DATASETDB_OPTION_CASE_INSENSITIVE) {
            rv = sqlite3_exec(getSqlite(), "INSERT INTO component (name, name_upper, ctime, mtime, type, version) VALUES ('aa', NULL, 0, 0, 0, 0)", NULL, NULL, &errmsg);
            if (rv != SQLITE_CONSTRAINT) {
                fatal("Expected SQLITE_CONSTRAINT error, got %d", rv);
            }
        }
        ...
        if (this->db_options & DATASETDB_OPTION_CASE_INSENSITIVE) {
            rv = sqlite3_exec(getSqlite(), "INSERT INTO component (name, name_upper, ctime, mtime, type, version) VALUES ('aa', 'AA', NULL, 0, 0, 0)", NULL, NULL, &errmsg);
        } else {
            rv = sqlite3_exec(getSqlite(), "INSERT INTO component (name, ctime, mtime, type, version) VALUES ('aa', NULL, 0, 0, 0)", NULL, NULL, &errmsg);
        }
        if (rv != SQLITE_CONSTRAINT) {
            fatal("Expected SQLITE_CONSTRAINT error, got %d", rv);
        }
        ...
        if (this->db_options & DATASETDB_OPTION_CASE_INSENSITIVE) {
            rv = sqlite3_exec(getSqlite(), "INSERT INTO component (name, name_upper, ctime, mtime, type, version) VALUES ('aa', 'AA', 0, NULL, 0, 0)", NULL, NULL, &errmsg);
        } else {
            rv = sqlite3_exec(getSqlite(), "INSERT INTO component (name, ctime, mtime, type, version) VALUES ('aa', 0, NULL, 0, 0)", NULL, NULL, &errmsg);
        }
        if (rv != SQLITE_CONSTRAINT) {
            fatal("Expected SQLITE_CONSTRAINT error, got %d", rv);
        }
        ...
        if (this->db_options & DATASETDB_OPTION_CASE_INSENSITIVE) {
            rv = sqlite3_exec(getSqlite(), "INSERT INTO component (name, name_upper, ctime, mtime, type, version) VALUES ('aa', 'AA', 0, 0, NULL, 0)", NULL, NULL, &errmsg);
        } else {
            rv = sqlite3_exec(getSqlite(), "INSERT INTO component (name, ctime, mtime, type, version) VALUES ('aa', 0, 0, NULL, 0)", NULL, NULL, &errmsg);
        }
        if (rv != SQLITE_CONSTRAINT) {
            fatal("Expected SQLITE_CONSTRAINT error, got %d", rv);
        }
        ...
        if (this->db_options & DATASETDB_OPTION_CASE_INSENSITIVE) {
            rv = sqlite3_exec(getSqlite(), "INSERT INTO component (name, name_upper, ctime, mtime, type, version) VALUES ('aa', 'AA', 0, 0, 0, NULL)", NULL, NULL, &errmsg);
        } else {
            rv = sqlite3_exec(getSqlite(), "INSERT INTO component (name, ctime, mtime, type, version) VALUES ('aa', 0, 0, 0, NULL)", NULL, NULL, &errmsg);
        }
        if (rv != SQLITE_CONSTRAINT) {
            fatal("Expected SQLITE_CONSTRAINT error, got %d", rv);
        }
        ...
        if (this->db_options & DATASETDB_OPTION_CASE_INSENSITIVE) {
            rv = sqlite3_exec(getSqlite(), "INSERT INTO component (id, name, name_upper, ctime, mtime, type, version) VALUES (1011, 'c-u-n-tid-a', 'C-U-N-TID-A', 0, 0, 0, 0)", NULL, NULL, &errmsg);
        } else {
            rv = sqlite3_exec(getSqlite(), "INSERT INTO component (id, name, ctime, mtime, type, version) VALUES (1011, 'c-u-n-tid-a', 0, 0, 0, 0)", NULL, NULL, &errmsg);
        }
        if (rv != SQLITE_OK) {
            fatal("Failed to insert into component table. Error %d", rv);
        }
        if (this->db_options & DATASETDB_OPTION_CASE_INSENSITIVE) {
            rv = sqlite3_exec(getSqlite(), "INSERT INTO component (id, name, name_upper, ctime, mtime, type, version) VALUES (1012, 'c-u-n-tid-b', 'C-U-N-TID-B', 0, 0, 0, 0)", NULL, NULL, &errmsg);
        } else {
            rv = sqlite3_exec(getSqlite(), "INSERT INTO component (id, name, ctime, mtime, type, version) VALUES (1012, 'c-u-n-tid-b', 0, 0, 0, 0)", NULL, NULL, &errmsg);
        }
        if (rv != SQLITE_OK) {
            fatal("Failed to insert into component table. Error %d", rv);
        }
        ...
        if (this->db_options & DATASETDB_OPTION_CASE_INSENSITIVE) {
            rv = sqlite3_exec(getSqlite(), "INSERT INTO component (id, name, name_upper, ctime, mtime, type, version) VALUES (1021, 'c-u-n-tid-a', 'C-U-N-TID-A', 0, 0, 0, 0)", NULL, NULL, &errmsg);
        } else {
            rv = sqlite3_exec(getSqlite(), "INSERT INTO component (id, name, ctime, mtime, type, version) VALUES (1021, 'c-u-n-tid-a', 0, 0, 0, 0)", NULL, NULL, &errmsg);
        }
        if (rv != SQLITE_OK) {
            fatal("Failed to insert into component table. Error %d", rv);
        }
        if (this->db_options & DATASETDB_OPTION_CASE_INSENSITIVE) {
            rv = sqlite3_exec(getSqlite(), "INSERT INTO component (id, name, name_upper, ctime, mtime, type, version) VALUES (1022, 'c-u-n-tid-b', 'C-U-N-TID-B', 0, 0, 0, 0)", NULL, NULL, &errmsg);
        } else {
            rv = sqlite3_exec(getSqlite(), "INSERT INTO component (id, name, ctime, mtime, type, version) VALUES (1022, 'c-u-n-tid-b', 0, 0, 0, 0)", NULL, NULL, &errmsg);
        }
        if (rv != SQLITE_OK) {
            fatal("Failed to insert into component table. Error %d", rv);
        }
        ...
        if (this->db_options & DATASETDB_OPTION_CASE_INSENSITIVE) {
            rv = sqlite3_exec(getSqlite(), "INSERT INTO component (id, name, name_upper, ctime, mtime, type, version) VALUES (1031, 'c-u-n-tid-a', 'C-U-N-TID-A', 0, 0, 0, 0)", NULL, NULL, &errmsg);
        } else {
            rv = sqlite3_exec(getSqlite(), "INSERT INTO component (id, name, ctime, mtime, type, version) VALUES (1031, 'c-u-n-tid-a', 0, 0, 0, 0)", NULL, NULL, &errmsg);
        }
        if (rv != SQLITE_OK) {
            fatal("Failed to insert into component table. Error %d", rv);
        }
