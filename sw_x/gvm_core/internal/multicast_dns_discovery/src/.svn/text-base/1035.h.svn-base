...
{
    char *name;
    unsigned short int type, class_;
};
...
struct resource
{
    ...
    union {
        ...
        struct { unsigned char *txt_raw; } txt;
        struct { unsigned char *ipv6; } aaaa;
        struct { unsigned short int priority, weight, port; char *name; } srv;
    } known;
};
...
struct message
{
    ...
    struct { unsigned char qr:1, opcode:4, aa:1, tc:1, rd:1, ra:1, z:3, rcode:4; } header;
