...
HttpSvc::Ccd::MediaFileSender::MediaFileSender(MediaFile *mf, const std::string &mediaType, HttpStream *hs)
    : mf(mf), mediaType(mediaType), hs(hs)
{
}

HttpSvc::Ccd::MediaFileSender::~MediaFileSender()
{
}

int HttpSvc::Ccd::MediaFileSender::Send()
{
...
int HttpSvc::Ccd::MediaFileSender::processRangeSpec()
{
    int err = 0;
...
int HttpSvc::Ccd::MediaFileSender::sendHttpHeaders()
{
    int err = 0;
...
int HttpSvc::Ccd::MediaFileSender::sendWholeFile()
{
    int err = 0;
...
int HttpSvc::Ccd::MediaFileSender::sendSingleRange()
{
...
int HttpSvc::Ccd::MediaFileSender::sendMultipleRanges()
{
    assert(ranges.size() > 1);
...
void HttpSvc::Ccd::MediaFileSender::generateBoundaryString(std::string &boundaryString)
{
